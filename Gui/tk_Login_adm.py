...
def consulta_adm(email,password):
    print(email)
    print(password)
...
def login_adm():
    ...
    ventana_inicio.title("Ventana inicio sesion - Administrador")
    ...
    #CREACION DE WIDGETS
    login_label = tkinter.Label(ventana_inicio, text = "LOGIN SUPERMARK - ADMINISTRADOR")
